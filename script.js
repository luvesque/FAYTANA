...
/* FRAMES PORTAL LIVE STACK */
(()=>{const p=document.querySelector('.portal-frames'),s=[...document.querySelectorAll('.frames-card-img')];if(!p||s.length!==3)return;const a=['/public/media/frames/frame-01.webp','/public/media/frames/frame-05.webp','/public/media/frames/frame-09.webp','/public/media/frames/frame-02.webp','/public/media/frames/frame-06.webp','/public/media/frames/frame-08.webp','/public/media/frames/frame-03.webp','/public/media/frames/frame-07.webp','/public/media/frames/frame-04.webp'];let n=3,k=0,t;function swap(){const i=s[k];i.style.opacity='0';setTimeout(()=>{i.src=a[n];i.onload=()=>i.style.opacity='1';n=(n+1)%a.length;k=(k+1)%s.length},260)}function run(ms){clearInterval(t);t=setInterval(swap,ms)}run(3000);p.addEventListener('mouseenter',()=>run(3000));p.addEventListener('mouseleave',()=>run(3000))})();
